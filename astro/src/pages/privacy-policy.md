...
- **Technical data** includes IP address/browser data/browser type and version/location/operating system and platform/other technology on the devices users use to access the website.
